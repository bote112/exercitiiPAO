...
public class Main {
        ...
        Collections.sort(sm.getMagazine(),
                Comparator
                        .comparing(Magazin::getProprietar,
                                Comparator.comparing(Proprietar::getNume).thenComparing(Proprietar::getPrenume))
    ...
    private static void venitTotal(ShoppingMall sm, Proprietar proprietar) {
        ...
        System.out.println("Venitul total al proprietarului " + proprietar.getNume() + " " + proprietar.getPrenume()
                + " este: " + total + ".\n");
    }
    ...
    private static void chirieTotal(ShoppingMall sm, Proprietar proprietar) {
        ...
        System.out.println("Chiria totala a proprietarului " + proprietar.getNume() + " " + proprietar.getPrenume()
                + " este: " + total + ".\n");
    }
}
